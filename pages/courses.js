...
export default function Courses() {
  ...
  const pageCopy = {
    ...
    fr: {
      ...
      intro:
        "L’ICSI s’adresse à trois publics distincts dans le monde moderne du cigare : les futurs professionnels construisant une carrière, les détaillants et lounges cherchant à se moderniser pour croître, ainsi que les aficionados engagés recherchant un niveau supérieur de maîtrise personnelle. Chaque parcours s’appuie sur le Cigar Peak-Flavor System® scientifique et vise à apporter davantage de structure, de confiance et de performance dans un paysage mondial de mélanges toujours plus complexe. ICSI est le premier au monde à proposer des cours de certification qui incluent : la science sensorielle, la quantification des saveurs/arômes, la classification des cigares basée sur les données, des outils numériques comme les applications, l'analytique, les systèmes de dégustation guidée). ICSI applique le cadre du système de qualité ISO/IEC 17024.",
