    ...
    <Layout>
      ...
      <div className="section coursesSection">
        <div className="container">
          <div className="introWide">
            <h1 className="coursesTitle">{p.title}</h1>

            <p
              className="lead coursesIntro"
