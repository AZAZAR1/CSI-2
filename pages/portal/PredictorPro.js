...
const BINDERS = ["","Cuban","Dominican","Nicaraguan","Honduran","Mexican","Brazilian","Peruvian","Cameroon","Costarican","San Andres","Connecticut","Sumatra","Ecuadorian","Broadleaf","Criollo","Corojo","Haitian","Hybrid / Other"];
const FILLER_OPTIONS = ["","Cuba","Cuban Viso","Alta Viso","Dominican Republic","Nicaragua","Honduras","Mexico","Costa Rica","Panama","Ecuador","Brazil","Peru","Cameroon","Colombia","United States","Piloto Cubano","Olor Dominicano","Corojo","Criollo","Ligero","Ecuadorian Ligero","Cuban Seco","Volado","Medio Tiempo","Zimbabwe","Paraguay","Haiti","Brena","Navarrete","South Africa"];
