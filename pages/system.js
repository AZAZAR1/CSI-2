        ...
        <div className="container">
          <div className="heroCard" style={{ marginTop: 14 }}>
            ...
            <div className="heroCardPad">
              <div className="heroTag">
                <i>Scientific Peak-Flavor System™</i>
              </div>
            </div>
          </div>
          ...
          <section className="peakFlavorText">
            ...
            <div className="lang en">
              ...
              <p className="lead">Controlled. Measured. Predictable.</p>
              <p>
                Most cigars are evaluated emotionally. Very few are evaluated
                thermodynamically. The Scientific Peak-Flavor System™ treats a
                cigar as a dynamic combustion system.
              </p>
              <ul>
              ...
              <p>
                Peak flavor occurs within a narrow moisture activation window
                specific to each blend family.
              </p>
            </div>
            ...
            <div className="lang fr">
              ...
              <p className="lead">Contrôlé. Mesuré. Prévisible.</p>
              <p>
                Le Scientific Peak-Flavor System™ considère le cigare comme un
                système de combustion dynamique.
              </p>
              <ul>
              ...
              <p>
                Le pic aromatique se situe dans une fenêtre d’humidité précise
            ...
            <div className="lang de">
              ...
              <p className="lead">Kontrolliert. Messbar. Reproduzierbar.</p>
              <p>
                Das Scientific Peak-Flavor System™ behandelt die Zigarre als
                dynamisches Verbrennungssystem.
              </p>
              <ul>
              ...
              <p>
                Maximales Aroma liegt in einem engen, blend-spezifischen
                Feuchtefenster.
              </p>
            </div>
          </section>
