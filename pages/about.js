...
export default function About() {
  ...
  const copy = {
    en: {
      ...
      qualityBody1:
        "ICSI is built upon a structured quality framework aligned with <strong>ISO/IEC 17024</strong>. This framework defines clear domains of competence across sensory analysis, combustion dynamics, humidity optimization, and client advisory, ensuring that certification reflects real-world professional capability.",
      qualityBody2:
    ...
    fr: {
      ...
      qualityBody1:
        "ICSI est fondé sur un cadre de qualité structuré conforme à <strong>ISO/IEC 17024</strong>. Ce cadre définit des domaines de compétence clairs en analyse sensorielle, dynamique de combustion, optimisation de l'humidité et conseil client, garantissant que la certification reflète la compétence professionnelle dans le monde réel.",
      qualityBody2:
      ...
      founderBody:
        "<strong>Anthony Azar</strong> devient une référence dans la science et l'appréciation des cigares haut de gamme. Son travail se situe à l'intersection de l'artisanat, de la science et du luxe moderne. Il redéfinit la manière dont les cigares sont compris, évalués et expérimentés. Diplômé de l'Imperial College de Londres, où il a obtenu des maîtrises en <strong>thermodynamique et science de la combustion</strong> ainsi qu'en administration des affaires, avec un accent sur la conception et le développement de technologies de suralimentation pour moteurs haute performance. Au cours d'une remarquable carrière de dirigeant de 25 ans, il a dirigé des initiatives mondiales dans les systèmes de formation avancés, l'excellence opérationnelle et la transformation numérique. Sa passion de toute une vie pour les cigares, qui s'étend sur plus de trois décennies, a conduit à la création du Cigar Peak-Flavor System, un cadre scientifique propriétaire conçu pour révéler l'expression optimale des saveurs grâce à l'équilibre thermodynamique. Désormais intégré dans une suite d'applications numériques, ce système offre une nouvelle norme de performance et de constance pour tous les blends de cigares.À travers son institut, Anthony propose une expérience éducative raffinée pour les amateurs et les professionnels avertis, élevant l'appréciation du cigare en une discipline de précision, de perspicacité et de maîtrise.",
